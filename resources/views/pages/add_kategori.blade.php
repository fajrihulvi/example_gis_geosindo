<!-- Modal -->
<div class="modal fade" id="addKategoriModal" tabindex="-1" aria-labelledby="addKategoriModal" aria-hidden="true">
  <div class="modal-dialog">
    <form action="{{ url('/kategori/store') }}" method="POST">
      @csrf
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="addKategoriModal">Tambah Kategori</h1>
      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="jenis_peta" id="jenis_peta1" value="TITIK">
              <label class="form-check-label" for="jenis_peta1">
                Titik Koordinat
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="jenis_peta" id="jenis_peta2" value="AREA">
